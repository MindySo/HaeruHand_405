...
public record WeatherWarningResponse(
    ...
    public static WeatherWarningResponse from(WeatherWarning weatherWarning) {
        return WeatherWarningResponse.builder()
                ...
                .warningType(weatherWarning.getWarningType() == null ? null : weatherWarning.getWarningType().label())
                .warningLevel(weatherWarning.getWarningLevel() == null ? null : weatherWarning.getWarningLevel().label())
                .warningCommand(weatherWarning.getWarningCommand() == null ? null : weatherWarning.getWarningCommand().label())
