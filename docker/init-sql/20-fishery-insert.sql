...
VALUES ('구업어촌계유어장', '제주시 애월읍 애월해안로 715-1', 33.484180, 126.377371, 'DT_0004', 'S1323100'),
       ...
       ('애월어촌계유어장(애월스쿠버)', '제주시 애월읍 13길 45', 33.466124, 126.321545, 'DT_0004', 'S1323100'),
       ('애월어촌계유어장(오션캠프)', '제주시 애월읍 애월해안로 93', 33.466447, 126.324428, 'DT_0004', 'S1323100'),
       ('수원어촌계유어장', '제주시 한림읍 한림로 782-6', 33.423654, 126.267283, 'SO_1277', 'S1323400');